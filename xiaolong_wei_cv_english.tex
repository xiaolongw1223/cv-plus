...
\begin{EntriesTable}
	\Duration{2023}{present}  &
	Geophysical Prospecting, Solid Earth
	\\
...
\begin{etaremune}
	...
	\item
	\Wei, et al., Uncertainty quantification of the stratigraphic model conditioned to airborne geophysics, geochemistry, and drillholes using Bayesian evidential learning (in prep)
	...
	\item
	\Wei, Sun, J. and Sen, M., 2023 3D Monte Carlo geometry inversion using gravity data. \emph{Geophysical Journal International}, (\Review)
	...
	\item
	\Wei, Sun, J. and Sen, M., 2022 Quantifying uncertainty of salt body shapes recovered from gravity data using trans-dimensional Markov chain Monte Carlo sampling. \emph{Geophysical Journal International}, 232(3), pp.1957-1978. \DOI{10.1093/gji/ggac430}

	\item
	\Wei, Li, K. and Sun, J., 2021 Mapping critical mineral resources using airborne geophysics, 3D joint inversion and geology differentiation: A case study of a buried niobium deposit in the Elk Creek carbonatite, Nebraska, USA. \emph{Geophysical Prospecting}. \DOI{10.1111/1365-2478.13280}

	\item
	\WeiSun, 2021. 3D probabilistic geology differentiation based on airborne geophysics, mixed Lp norm joint inversion and petrophysical measurements. \emph{Geophysics}, 87(4), pp.1-67.
	\DOI{10.1190/geo2021-0833.1}

	\item
	Hu, Y., \Wei, Wu, X., Sun, J., Chen, J., Huang, Y. and Chen, J., 2021. A deep learning enhanced framework for multi-physics joint inversion. \emph{Geophysics}, 88(1), pp.1-70. \DOI{10.1190/geo2021-0589.1}
...
\begin{etaremune}
	...
	\item
	\Wei, Sun, J. and Sen, M., 2022. Trans-dimensional Bayesian gravity inversion and uncertainty analysis for salt reconstruction. In \emph{IMAGE Technical Program Expanded Abstracts 2022}
...
\begin{EntriesTable}
	...
	\Year{09/2022} &
	A Bayesian framework for uncertainty quantification of salt body shapes using gravity data. \emph{Geophysical Society of Houston}.
	\\

	\Year{11/2021} &
	Build probabilistic quasi-geology models based on multiple airborne geophysical data and sparse joint inversions (online). \emph{Geophysical Society of Houston}.
	\\

	\Year{09/2021} &
	From deterministic to probabilistic geoscience modeling: analyzing uncertainties of geophysical inversions and constructing probabilistic subsurface models conditioned on petrophysical measurements (online). \emph{SimPEG monthly seminar}.
