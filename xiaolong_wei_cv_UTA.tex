...
\begin{etaremune}
	...
	\item
	Hu, Y., \Wei, Wu, X., Sun, J., Chen, J., Huang, Y. and Chen, J., 2023. 3D joint inversion of airborne magnetic and gravity gradient data using deep learning techniques. \emph{Geophysics}, (accepted for publication)
...
\begin{EntriesTable}
	...
	\Year{07/2023} &
	Sun, J., and \Wei, Building probabilistic quasi-geology models and mapping mineral resources using joint inversion and geology differentiation, \emph{XXVIII General Assembly of the International Union of Geodesy and Geophysic} (IUGG) (Berlin 2023). \DOI{10.57757/IUGG23-4333}.
	\\
