...
%\begin{EntriesTable}
%	\Duration{2020}{2021}  &
%	\$1,000; Proposal:“Uncertainty Analysis of Geophysical Inversions Conditioned on Spatial Distributions of Geologic Units”; Student Research Funding Program (independent of advisor) from ; PI: Xiaolong Wei
%\end{EntriesTable}
...
%\begin{EntriesTable}
%	\Year{2020}  &
%	GEOL7330: Potential Field Methods of Geophysical Exploration (graduate core course), Class size: 25+, \textbf{Guest Lecturer}. \emph{University of Houston}.
%	\\
%	\Year{2019}  &
%	GEOL4355: Geophysical Field Camp, Class size: 15+, \textbf{Teaching Assistant}. \emph{University of Houston}.
%\end{EntriesTable}
